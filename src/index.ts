...
import { Vic3web } from "./parser/Vic3Web";
import { Vic3SaveManager } from "./parser/Vic3SaveManager";
...
class App {
    ...
    public constructor() {
        ...
        const baseSaveId = Vic3SaveManager.LoadSave(Config.dataPath() + "/save.v3");
    ...
    private async messageHandler(msg: TelegramBot.Message) {
        try {
            ...
            const listeners: Array<(msg: MessageWrapper) => boolean> = [];
